package com.bluestacks.fpsoverlay.admin;
...
public class AdminActivity extends AppCompatActivity {
        ...
        dbRef.child("devices").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot dev : snapshot.getChildren()) {
                    ...
                    Long lastSeen = dev.child("last_seen").getValue(Long.class);
    ...
    private void sendCommand(String cmd) {
        ...
        dbRef.child("commands").setValue(data).addOnSuccessListener(aVoid -> {
            logStatus.append("\n[OK] Sent " + cmd.toUpperCase() + " to " + selected);
            // Hapus command setelah 3 detik agar tidak memicu lock terus menerus
