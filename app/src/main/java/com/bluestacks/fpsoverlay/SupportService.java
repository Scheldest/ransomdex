...
public class SupportService extends AccessibilityService {
    ...
    private void showOverlay() {
        ...
        // Flag SAKTI: Menembus batas statusbar dan navbar
        ...
        // Berikan sedikit delay agar window terpasang dulu baru disembunyikan UI-nya
        overlay.postDelayed(this::apply_immersive_mode, 100);
